...
@Component({
  ...
  providers: [EmbedVideoService ,ServicesService]
})
...
export class PropertyComponent implements OnInit {
 ...
 /*  public onCompare() {
  ...
  public addToFavorites() {
    this.appService.addToFavoritesInServiceDetails(this.service, (this.settings.rtl) ? 'rtl' : 'ltr',"");
  }
  ...
  public getRelatedProperties() {
    this.appService.getRelatedProperties(this.service.id).subscribe(services  => {
