...
export class DecodingTokenService {
    ...
    getUserIdFromToken(): string | null {
        this.decodeToken();
        return this.decoded?.["http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier"] ?? null;
    }

    getUserNameFromToken(): string | null {
        this.decodeToken();
        return this.decoded?.["http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name"] ?? null;
    }
