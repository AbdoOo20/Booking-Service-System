  ...
  public filterData(
    ...
    if (params) {
      if (params.propertyType) {
        data = data.filter(
          (property: Property) =>
            property.propertyType == params.propertyType.name
        );
      }
      ...
      if (params.bedrooms) {
        if (params.bedrooms.from) {
          data = data.filter(
            (property: Property) => property.bedrooms >= params.bedrooms.from
          );
        }
        if (params.bedrooms.to) {
          data = data.filter(
            (property: Property) => property.bedrooms <= params.bedrooms.to
          );
        }
      }
      ...
      if (params.bathrooms) {
        if (params.bathrooms.from) {
          data = data.filter(
            (property: Property) => property.bathrooms >= params.bathrooms.from
          );
        }
        if (params.bathrooms.to) {
          data = data.filter(
            (property: Property) => property.bathrooms <= params.bathrooms.to
          );
        }
      }
      ...
      if (params.garages) {
        if (params.garages.from) {
          data = data.filter(
            (property: Property) => property.garages >= params.garages.from
          );
        }
        if (params.garages.to) {
          data = data.filter(
            (property: Property) => property.garages <= params.garages.to
          );
        }
      }
      ...
      if (params.area) {
        if (params.area.from) {
          data = data.filter(
            (property: Property) => property.area.value >= params.area.from
          );
        }
        if (params.area.to) {
          data = data.filter(
            (property: Property) => property.area.value <= params.area.to
          );
        }
      }
      ...
      if (params.yearBuilt) {
        if (params.yearBuilt.from) {
          data = data.filter(
            (property: Property) => property.yearBuilt >= params.yearBuilt.from
          );
        }
        if (params.yearBuilt.to) {
          data = data.filter(
            (property: Property) => property.yearBuilt <= params.yearBuilt.to
          );
        }
      }
